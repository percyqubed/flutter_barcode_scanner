...
class FlutterBarcodeScanner {
  static const MethodChannel _channel = MethodChannel('qubed_barcode_scanner');

  static const EventChannel _eventChannel = EventChannel('qubed_barcode_scanner_receiver');
